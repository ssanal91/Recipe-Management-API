...
router.register('user',views.UserViewset,basename='userdetails')
router.register('createreview',views.createreview,basename='create')


urlpatterns = [
    path('admin/', admin.site.urls),
    path('rec',include("Recipe.urls")),
    path('',include(router.urls)),
    path('api-token-auth/',rviews.obtain_auth_token),#login View url
    path('cuisine',views.Cuisinefilter.as_view()),
    path('meal', views.mealfilter.as_view()),
    path('cont',views.ingredientfilter.as_view()),
